...
public class LightSystemActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        product.setOnClickListener(new LightSystemActivity.MyOnClickListener());
    }
    class MyOnClickListener implements View.OnClickListener{
        @Override
        public void onClick(View v) {
            if(v.getId()==R.id.product) {
                Intent intent = new Intent(LightSystemActivity.this, LightDetailActivity.class);
                startActivity(intent);
            }else{
                Intent intent = new Intent(LightSystemActivity.this, BuyActivity.class);
                startActivity(intent);
            }
        }
    }
