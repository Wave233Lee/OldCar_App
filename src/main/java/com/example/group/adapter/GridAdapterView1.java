...
public class GridAdapterView1 extends RecyclerView.Adapter<ViewHolder> implements
        OnItemClickListener, OnItemLongClickListener {
    private final static String TAG = "GridAdapterView1";
    ...
    public GridAdapterView1(Context context, ArrayList<GoodsInfo> goodsArray) {
        mContext = context;
