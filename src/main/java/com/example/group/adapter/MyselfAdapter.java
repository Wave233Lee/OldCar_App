...
public class MyselfAdapter extends RecyclerView.Adapter<ViewHolder> implements
        OnItemClickListener, OnItemLongClickListener {
    private final static String TAG = "GridAdapter";
    private Context mContext;
    private LayoutInflater mInflater;
    private ArrayList<MyselfInfo> mGoodsArray;

    public MyselfAdapter(Context context, ArrayList<MyselfInfo> goodsArray) {
        mContext = context;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup vg, int viewType) {
        ...
        v = mInflater.inflate(R.layout.item_grid_myself, vg, false);
