...
public class FindCarActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    private void initViews() {
        ...
        listViews.add(mInflater.inflate(R.layout.findcar_view1, null, false));
        listViews.add(mInflater.inflate(R.layout.findcar_view2, null,false));
        listViews.add(mInflater.inflate(R.layout.findcar_view3, null, false));
        listViews.add(mInflater.inflate(R.layout.findcar_view4, null, false));
