...
public class SaleAdapter extends RecyclerView.Adapter<ViewHolder> implements
        OnItemClickListener, OnItemLongClickListener {
    private final static String TAG = "GridAdapter";
    private Context mContext;
    private LayoutInflater mInflater;
    private ArrayList<SaleInfo> mGoodsArray;

    public SaleAdapter(Context context, ArrayList<SaleInfo> goodsArray) {
        mContext = context;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup vg, int viewType) {
        ...
        v = mInflater.inflate(R.layout.item_sale, vg, false);
